...
const Hotel = () => {
  ...
  return (
    <div>
        ...
        <div className="hotelWrapper">
          ...
          <div className="hotelDetails">
            ...
            <div className="hotelDetailsPrice">
              ...
              <span>
                Located in the real heart of <span className='capitalizeCity'>{data.city}</span> , this property has an excellent location!
              </span>
              <h2>
      ...
      {openModal && <Reserve setOpen={setOpenModal} hotelId={id} days={days} dates={dates} />}
    </div>
  )
}
