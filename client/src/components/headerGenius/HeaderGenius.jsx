...
const HeaderGenius = () => {
  ...
  return (
      <div className='headerGenius'>
          <div className="headerGeniusContainer">
                      <h1 className="headerTitle">Make the most of Genius Level 1</h1>
              <p className="headerDesc">
                There are thousands of Genius properties, both close to home and farther away. Where will you go next?
              </p>
