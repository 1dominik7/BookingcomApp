...
const CarInstructionDropOff = ({ data, setOpenDropOff }) => {
  ...
  return (
    <div className='carInstructionContainer'>
              ...
              <FontAwesomeIcon icon={faXmark} className='carInstructionCross' onClick={() => setOpenDropOff(false)} />
...
export default CarInstructionDropOff
